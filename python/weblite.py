# Public Domain (-) 2008-present, The Espian Source Authors.
...
try:
    ...
    from config import ERROR_401, ERROR_403, ERROR_404, ERROR_500, ERROR_503
...
<body>
%%s""" % str(STATIC('error.css'))

    ERROR_401 = ERROR_WRAPPER % """
  <div class="site-error">
    <h1>Not Authenticated</h1>
    <p>Your session may have expired or you may not have access.</p>
    <ul>
  ...
  <div class="site-error">
    ...
    <p>Sorry, your account is not authorised to perform this action.</p>
    <ul>
      <li><a href="/">Return home</a></li>
    </ul>
  </div>
  ...
  <div class="site-error">
    ...
    <p>You may have clicked a dead link or mistyped the address. Some web addresses
  ...
  <div class="site-error">
    ...
    <p>There was an application error. This has been logged and will be resolved as
    soon as possible.</p>
    <ul>
      <li><a href="/">Return home</a></li>
    </ul>
  ...
  <div class="site-error">
    ...
    <p>Google App Engine is currently down for a scheduled maintenance.
...
# The ``AuthenticationError`` is used to represent the 401 Not Authorized error.
class AuthenticationError(BaseHTTPError):
    pass

# The ``AuthorisationError`` is used to represent the 403 Forbidden error.
class AuthorisationError(BaseHTTPError):
    pass
...
class Context(object):
    ...
    try:
        from user import get_admin_status
    except ImportError:
...
def handle_http_request(
    ...
    # Handle 404s.
        ...
        logging.info("RESPONDING: %r" % (ERROR_404,))
        return [ERROR_404]
