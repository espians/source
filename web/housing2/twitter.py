# Public Domain (-) 2009-present, The Espian Source Authors.
...
class Client(object):
    ...
    post_methods = frozenset([
        'account/remove_profile_banner', 'account/settings',
        'account/update_delivery_device', 'account/update_profile',
        'account/update_profile_background_image',
        'account/update_profile_banner', 'account/update_profile_colors',
        'account/update_profile_image', 'blocks/create', 'blocks/destroy',
        'direct_messages/destroy', 'direct_messages/new', 'favorites/create',
        'favorites/destroy', 'friendships/create', 'friendships/destroy',
        'friendships/update', 'geo/place', 'lists/create', 'lists/destroy',
        'lists/members/create', 'lists/members/create_all',
        'lists/members/destroy', 'lists/members/destroy_all',
        'lists/subscribers/create', 'lists/subscribers/destroy', 'lists/update',
        'saved_searches/create', 'saved_searches/destroy', 'statuses/destroy',
        'statuses/filter', 'statuses/update_with_media', 'users/report_spam'
    ])
    ...
    def get_access_token(self, oauth_token, oauth_secret, oauth_verifier):
        ...
        if resp.status_code != 200:
            ...
            raise RequestError(resp)
        return dict(
            tuple(param.split('=')) for param in resp.content.split('&')
        )
